...
% La negación se puede representar como una lista de 
% dos elementos: la palabra neg y una expresión lógica.
% Las conjunciones, disyunciones e implicaciones se pueden representar como 
% una lista de tres elementos: el alcance izquierdo, la conexión lógica y el alcance derecho.
